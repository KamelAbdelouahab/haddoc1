...
caffe test -model caffe/networks/caffe3-lenet_train.prototxt -weights caffe/networks/caffe3-lenet.caffemodel -iterations 500 -gpu 0
caffe test -model caffe/networks/caffe3-lenet_test.prototxt  -weights caffe/networks/caffe3-lenet.caffemodel -iterations 500 -gpu 0
